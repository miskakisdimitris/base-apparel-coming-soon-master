...
function App() {
  return (
    <div id="body-style">
      <div id="arrows-div">
            <svg id="arrow-svg-1" xmlns="http://www.w3.org/2000/svg" width="80pt" viewBox="0 0 48 80" version="1.1">
                <g id="surface1">
                    <path id="path-style" d="M 1 1 L 9.835938 9.835938 L 1 18.670898 " transform="matrix(4,0,0,4,0,0)"/>
                </g>
            </svg>
            <svg id="arrow-svg-2" xmlns="http://www.w3.org/2000/svg" width="80pt" viewBox="0 0 48 80" version="1.1">
                <g id="surface1">
                    <path id="path-style" d="M 1 1 L 9.835938 9.835938 L 1 18.670898 " transform="matrix(4,0,0,4,0,0)"/>
                </g>
            </svg>
            <svg id="arrow-svg-3" xmlns="http://www.w3.org/2000/svg" width="80pt" viewBox="0 0 48 80" version="1.1">
                <g id="surface1">
                    <path id="path-style" d="M 1 1 L 9.835938 9.835938 L 1 18.670898 " transform="matrix(4,0,0,4,0,0)"/>
                </g>
            </svg>
      ...
      <div id="main-div">
        <div id="text-div">
          ...
          <p id="coming-soon-par">
            ...
            <form>
              <input type="email" id="email" placeholder="Email Address" class="input" required></input>
        ...
        <img id="woman-img" src={require('./hero-desktop.jpg')} alt=""></img>
      </div>
    </div>
);
}
